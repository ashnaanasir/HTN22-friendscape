...
const GreetingCard = () => {
    ...
    return (
        <View style={{width: 350, height: 300, backgroundColor: '#eee', borderRadius: 20, marginBottom: 25}}>
            <Text style={styles.greetingHeading}>Hello, 
            <Text style={styles.greetingUsername}> {username}</Text>
            </Text>
            <Image source={{uri: '../../assets/Pika.png'}} style={{width: 250, height: 300, marginTop: 10,}} />
